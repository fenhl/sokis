...
<html>
    ...
    <?php
        ...
        if ($this->data['title'] == 'User:Fenhl') {
            ...
            ?>
                <h1><a href="/" title="Fenhl"><img style="display: inline-block; height: 55px; width: 55px;" src="<?php $this->text('logopath') ?>" /></a> / <?php $this->data['displaytitle']!=""?$this->html('title'):$this->text('title'); ?></h1>
            <?php
        }
    ?>
